...
func (n *node) updateContainer(c dockerclient.Container, containers map[string]*cluster.Container, full bool) (map[string]*cluster.Container, error) {
	...
	if full {
		...
		container.Info.Config.CpuShares = container.Info.Config.CpuShares / 1024 * n.Cpus
	}
...
func (n *node) TotalCpus() float64 {
	return (float64(100*n.Cpus+n.Cpus*n.overcommitRatio) / 100)
}

func (n *node) GetCpus() int64 {
	return n.Cpus
}
